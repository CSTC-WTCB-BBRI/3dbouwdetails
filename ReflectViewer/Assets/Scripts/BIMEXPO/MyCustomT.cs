...
class BuilderAttributesTestElement : VisualElement
{
    ...
    public new class UxmlTraits : VisualElement.UxmlTraits
    {
        ...
        UxmlBoolAttributeDescription m_Bool2 = new UxmlBoolAttributeDescription { name = "bool-attr2", defaultValue = false };
        ...
        public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
        {
            ...
            //ate.boolAttr2 = m_Bool2.GetValueFromBag(bag, cc);
            ////ate.Add(new VisualElement() { value = ate.boolAttr });
